            ...
            <div class="align-center container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <p></p>
                        <div align="center">
                            <font size="7"><span style="color:#000000">Add score</span></font>
                            <form action="adding_score" enctype="multipart/form-data" method="post">
                                <p></p>
                                <table align="center" border="0">
                                    ...
                                    <td><input name="score_name" placeholder="Score name" type="text" style="width:300px;height:40px;"></td>
                                    <td><input id="file_da_caricare" name="score_file" style="width:360px;height:30px;" type="file"></td>
                                </table>
                                <p></p>
                                <p></p>
                                <div align="center">
                                    <input name="upload_button" style="background:#FFFFFF;color:#000000;width:300px;height:40px;border-radius: 15px 50px 30px;" type="submit" value="Add score (pdf)">
                                    <p></p>
                                    <p><a class="btn" href="scores_search_bar">Back</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
