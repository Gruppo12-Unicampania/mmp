            ...
            <div class="align-center container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        ...
                        <form action="add_midi" method="post">
                            <div align="center"> 

                                <font size="3"><span style="color:#232323">Search a song, then click on id to add midi to the linked song</span></font><br>
                                <table border="0" width="352">
                                    ...
                                    <%
                                        {
                                            List data = getList.GetSongsSearch((String) login.getAttribute("name"));
                                ...
                                <form action ="midi_search_servlet" method="post">
                                    <div align="center">
