...
<html>
    ...
    <body>
        <form action="redirect_toplayer_to_add_playlist" method="post">
                ...
                <div class="align-center container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                            <p></p>
                            <div align="center">
                                <font size="7"><span style="color:#232323"><% login.getAttribute("playlist"); %></span></font><br>
                                <table border="0" width="303">
                                    <thead>
                                        <tr> 
                                            <th>Song title</th>
                                            <th>Go to player button</th> 
                                        </tr>
                                    </thead>
                                    ...
                                    <%
                                        {
                                            List data = getList.getSonginPlaylist((String) login.getAttribute("playlist"), (String) login.getAttribute("user"));
                                            for (itr = data.iterator(); itr.hasNext();) {
                                    %>
                                    <td><div align='center'><%=itr.next()%>
                                    </td><td><input type='submit' style="background:#232323;color:#232323;width:30px;height:30px;border-radius: 15px 50px 30px;" name='id_song' value='<%=itr.next()%>'></td>
                                    <tr>
                                        <%
                                                            }
                                                        }%>
                                ...
                                <p></p>
                                <p>
                                    <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="search_bar"> Add song</a>
                                </p>
                                <p>
                                    <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="pl_remove_song"> Remove song</a>
                                </p>
                                <p>
                                    <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="main_space"> Back</a>
                                </p>
