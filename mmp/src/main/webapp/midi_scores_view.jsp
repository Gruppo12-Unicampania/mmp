            ...
            <div class="align-center container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <p></p>
                        <div align="center">
                            <a class="btn" href="midi_search_bar">Upload Midi</a>
                            <a class="btn" href="scores_search_bar">Upload scores</a> <p></p>
                            <a class="btn" href="approved_midi_search">View Midi</a>
                            <a class="btn" href="approved_score_search">View scores</a> <p></p> 
                            <p>
