                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        ...
                        <div align="center"> 
                            ...
                            <font size="3"><span style="color:#232323">Search a song, then click on the black button to download midi</span></font><br>
                            <table border="0" width="352">
                                ...
                                <%
                                    {
                                        List data = getList.GetSongsMidiSearch((String) login.getAttribute("name"));
                            ...
                            <form action ="midi_approved_search" method="post">
                                <div align="center">
