...
<body>
	<form action="song_admin_space" method="post">
			...
			<div class="align-center container-fluid">
				<div class="row justify-content-center">
					<div class="col-12 col-lg-8">
						<p></p>
						<div align="center">
							<font size="7"><span style="color:#232323">In the chosen album:</span></font><br>
                                                        ...
                                                        <%Iterator itr;%>
                                                        <% 
                                                        {List data= getList.GetSongs((String) login.getAttribute("user"),(String) login.getAttribute("album"));
                                                        ...
                                                        <p></p>
                                                        <p>
                                                            <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="add_song"> Add song</a>
                                                        </p>
                                                        <p>
                                                            <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="delete_song"> Remove song</a>
                                                        </p>
