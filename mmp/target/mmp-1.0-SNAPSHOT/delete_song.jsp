                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        ...
                        <form action="remove_song" method="post">
                            <div align="center"> 
                                <font size="7"><span style="color:#232323">Songs in the album:</span></font><br> 
                                <table border="0" width="352">
                                    <thead>
                                        <tr> 
                                            <th>Song title</th>
                                            <th>ID (click to delete)</th>
                                        </tr>
                                    </thead>
                                    <%Iterator itr;%>
                                    <%
                                        {
                                            List data = getList.GetSongsRm((String) login.getAttribute("user"), (String) login.getAttribute("album"));
                                            for (itr = data.iterator(); itr.hasNext();) {
                                    %>
                                    <tr><td><div align='center'><%=itr.next()%> </td>                                    
                                        <td><input type="submit" name="id_song" value='<%=itr.next()%>' src="image/tastopiù.jpg" style="background:#232323;color:#ffffff;width:30px;height:30px;border-radius: 50%;">
                                            <%
                                                    }
                                                }
                                            %>
