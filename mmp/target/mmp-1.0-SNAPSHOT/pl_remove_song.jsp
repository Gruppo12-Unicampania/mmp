...
<html>
    ...
    <body>
        <form action="rmsong" method="post">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                            ...
                            <div align="center">
                                ...
                                <p></p>
                                <p>
                                    <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="playlist_space"> Back</a>
                                </p>
