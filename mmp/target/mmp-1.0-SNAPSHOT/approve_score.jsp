...
<html>
    ...
    <body>
        <form action="scores_servlet" method="post">
                ...
                <div class="align-center container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                            <p></p>
                            <div align="center">
                                <font size="7"><span style="color:#232323">Pending scores:</span></font><br>
                                <table border="0" width="303">
                                    ...
                                    <%
                                        {
                                            List data = getList.GetPendingScores(getList.getId((String) login.getAttribute("user")));
                                            for (itr = data.iterator(); itr.hasNext();) {
                                    %>
                                </td><td><div align='center'><%=itr.next()%>
                            </td><td><div align='center'><a class="btn" href='<%=itr.next()%>' style="background:#232323;color:#232323;width:40px;height:30px;border-radius: 50%;">
                                    </td><td><div align='center'><input type="submit" name="path" class="btn" value='<%=itr.next()%>' src="image/tastopiù.jpg" style="background:#232323;color:#232323;width:40px;height:30px;border-radius: 50%;"></td></tr>
                                        <%
                                                                }
                                                            }%>
                                        ...
                                        <p></p>
                                        <p>
                                            <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="album_space"> Back</a>
                                        </p>
