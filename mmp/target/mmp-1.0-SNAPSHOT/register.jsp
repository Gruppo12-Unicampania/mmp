            ...
            <div class="align-center container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <p></p>
                        <div align="center">
                            <font size="7"><span style="color:#232323">Registration</span></font>
                            <form method="post" action="Register">
                                <p>
                                <table align="center" border="1">
                                    <tr><td><img src="image/username_image.png"style="width:25px;height:25px"></td><td><input type="text" name="username" style="width:150px;heigth=25px" placeholder="Username (6/16 chars)"></td></tr>
                                    <tr><td><img src="image/password_image.png"style="width:25px;height:25px"></td><td><input type="password" name="password"style="width:150px;heigth=25px" placeholder="Password (6/16 chars)"></td></tr>
                                    <tr><td><img src="image/confirm_password_image.png"style="width:25px;height:25px"></td><td><input type="password" name="confirm_password" style="width:150px;heigth=25px" placeholder="Confirm password"></td></tr>
                                    <tr><td><img src="image/email_image.png"style="width:25px;height:25px"></td><td><input type="email" name="email" style="width:150px;heigth=25px" placeholder="Email"></td></tr>
                                </table>
                                </p>
                                <p>
                                <div align="center"><input type="submit" style="background:#FFFFFF;color:#000000;width:150px;height:40px;border-radius: 15px 50px 30px;"name="registration_button" value="Register">
                                    </p>
                                    </form>
                                </div>
                        </div>
