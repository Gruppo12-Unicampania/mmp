...
<html>
    ...
    <body>
        <form action="midi_servlet" method="post">
                ...
                <div class="align-center container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                            <p></p>
                            <div align="center">
                                <font size="7"><span style="color:#232323">Pending midis:</span></font><br>
                                <table border="0" width="303">
                                    ...
                                    <%
                                        {
                                            List data = getList.GetPendingMidi(getList.getId((String) login.getAttribute("user")));
