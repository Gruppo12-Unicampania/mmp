...
<html>
    ...
    <body>
        <form action="vip_req" method="post">
                ...
                <div class="align-center container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                            <p></p>
                            <div align="center">
                                <font size="5"><span style="color:#232323">Here you are </span></font><br></p>
                                <font size="5"><span style="color:#232323">Make a request to the admin! </span> </p><p></p>
                                <table border="0" width="303">



                                    <tr><td><div align='center'><input type='submit' style="background:#232323;color:#ffffff;width:300px;height:90px;border-radius: 15px 50px 30px;" name='button' value='Submit'>
                                                <tr>
                                                    </table> 
                                                <font size="5"><span style="color:#232323">(Payment not supported yet, send a mail to the admin) </span> </p><p></p>
                                                <p></p>
                                                </p>
                                            </div>
                                            </div>
