...
<%
    ...
    if ("1".equals(getList.isVip((String) login.getAttribute("user")))) {
        login.setAttribute("VIP", "TRUE");
    } else {
        login.setAttribute("VIP", "FALSE");
    }
...
<html>
    ...
    <body>
        <form action="redirect_playlist" method="post">
                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav nav-dropdown nav-right" data-app-modern-menu="true">
                                ...
                                <li class="nav-item">
                                    <% if ("TRUE".equals(login.getAttribute("VIP"))) {%>
                                    <a class="nav-link link text-black display-4" href="midi_scores_view">Vip Area</a>
                                    <%} else { %><a class="nav-link link text-black display-4" href="vip_request">Become a VIP!</a> <% } %>
                ...
                <div class="align-center container-fluid">
                    <div class="row justify-content-center">
                        <div class="col-12 col-lg-8">
                            <p></p>
                            <div align="center">
                                <font size="7"><span style="color:#232323">Your playlists:</span></font><br>
                                <table border="0" width="303">

                                    <%Iterator itr;%>
                                    <%
                                        {
                                            List data = getList.GetPlaylist((String) login.getAttribute("user"));
                                            for (itr = data.iterator(); itr.hasNext();) {
                                    %>
                                    <tr><td><div align='center'><input type='submit' style="background:#232323;color:#ffffff;width:300px;height:40px;border-radius: 15px 50px 30px;" name='Playlist_name' value='<%=itr.next()%>'>
                                            </td><td><img alt="image" src="<%=itr.next()%>" style="background:#232323;color:#ffffff;border-radius: 15px 20px 20px;width:39px;height:39px;"></td>
                                        <tr>
                                            <%
                                                                }
                                                            }%>
                                        ...
                                        <p></p>
                                        <p>
                                            <a class= "btn "style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="add_playlist"> Add playlist</a>
                                        </p>
                                    </div>
                                    </div>
                                    </div>
