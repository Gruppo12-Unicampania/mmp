...
<%
    ...
    if ("FALSE".equals((String) login.getAttribute("VIP"))) {
                ...
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        ...
                        <div align="center"> 
                            ...
                            <font size="3"><span style="color:#232323">Search a song, then click on the black button to download score</span></font><br>
                            <table border="0" width="352">
                                ...
                                <%
                                    {
                                        List data = getList.GetSongsScoresSearch((String) login.getAttribute("name"));
                                        for (itr = data.iterator(); itr.hasNext();) {
                                %>
                                <tr><td><div align='center'><%=itr.next()%>
                                    </td><td><div align='center'><%=itr.next()%>
                                    </td><td><div align='center'><%=itr.next()%>
                                    </td><td><a class="btn" href='<%=itr.next()%>' src="image/tastopiù.jpg" style="background:#232323;color:#232323;width:40px;height:30px;border-radius: 50%;">
                                            <%
                                                    }
                                                }
                            ...
                            <form action ="scores_approved_search" method="post">
                                <div align="center">
                                    <input type="text" name="name" placeholder="Search by name"> 
                                    <input type ="submit"  style="background:#232323;color:#ffffff;width:145px;height:30px;border-radius: 20px 60px 30px;" value="Search">   
                                </div>
                                <p></p>
                                <p>
                                    <a class="btn" style="background:#ffffff;color:#232323;width:300px;height:40px;border-radius: 15px 50px 30px;" href="midi_scores_view"> Back</a>
                                </p>
