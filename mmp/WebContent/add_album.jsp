            ...
            <div class="align-center container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <p></p>
                        <div align="center">
                            <font size="7"><span style="color:#000000">Add album</span></font><p></p>
                            <font size="5"><span style="color:#000000">(and its cover image)</span></font>
                            <form action="adding_album" enctype="multipart/form-data" method="post">
                                <p></p>
                                <table align="center" border="0">
                                    <tr>
                                        <td><img alt="Name" src="image/Album.png" style="width:25px;height:25px"></td>
                                        <td><input name="album_name" placeholder="Album name" type="text" style="width:300px;height:40px;"></td>
                                    </tr>
                                    <td><button class="button" name="uploadimg_button" type="submit"><img src="image/symbol.png" style="width:25px;height:25px"></button></td>
                                    <td><input id="file_da_caricare" name="album_cover" style="width:360px;height:30px;" type="file"></td>
                                </table>
                                <p></p>
                                <p></p>
                                <div align="center">
                                    <input name="upload_button" style="background:#FFFFFF;color:#000000;width:300px;height:40px;border-radius: 15px 50px 30px;" type="submit" value="Add album">
                                    <p></p>
                                    <p><a class="btn" href="album_space">Back</a></p>
                                </div>
                            </form>
                        </div>
                    </div>
